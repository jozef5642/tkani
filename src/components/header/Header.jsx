    ...
    <header className="w-full bg-light text-dark font-inter border-b border-light/10 relative z-50">
      ...
      <section className="flex justify-between items-center px-4 sm:px-6 lg:px-8 py-4 bg-light text-accentDark relative">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative hidden lg:inline-block">
            ...
            {isOpen && (
              <div
                className="absolute left-0 mt-2 w-[700px] bg-light text-dark rounded-xl shadow-lg 
                           transition-all duration-300 ease-in-out z-50 animate-fadeIn"
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
              >
                <div className="bg-[#FFFF] p-4 grid grid-cols-2 gap-3 rounded-xl">
                  <ul className="bg-[#F1F0EE] p-4 grid grid-cols-1 gap-3 rounded-lg">
                    <li className="cursor-pointer hover:text-accent">Портьерные ткани</li>
                    <li className="cursor-pointer hover:text-accent">Тюль и вуаль</li>
                    <li className="cursor-pointer hover:text-accent">Аксессуары</li>
                    <li className="cursor-pointer hover:text-accent">Новинки</li>
                    <li className="cursor-pointer hover:text-accent">Распродажа</li>
                    <li className="cursor-pointer hover:text-accent">Ткани для мебели</li>
                  </ul>
      ...
      >
        ...
        <nav className="flex flex-col gap-3 p-4">
          <Link to="/about_us" className="hover:text-accent">О нас</Link>
